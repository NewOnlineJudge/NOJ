export const m = {
  ...
  Username_Check_Max: '用户名长度不能超过 20 位',
  Password_Check_Required: '密码不能为空',
  Password_Check_Between: '请输入长度为 6 ~ 20 位的密码',
  Welcome_Back: '欢迎回来~',

  // /components/oj/common/Register.vue 注册弹窗
  Register_Username: '请输入原 NOJ 的用户名',
  Rename_Test: '请将你在原 NOJ 的格言改为 ',
  ...
  is_incorrect_format_file: '的文件格式不正确，请选择 gif / jpg / jpeg / png / bmp / webp 格式的图片文件。',
  Exceed_max_size_limit: '超过文件大小限制',
  File_Exceed_Tips: '文件大小错误, 您只能上传不大于 2MB 的图片文件！',
  ...
  UserHome_Score: 'OI 分数',
  UserHome_Rating: 'CF 分数',
  ...
  Code_Length_can_not_exceed_65535: '代码太长了！',
  ...
  Refresh: '刷新',
  Enter_Problem_ID: '请输入题目 ID',
  Enter_Author: '请输入作者',
  Run_ID: 'Run ID',
  Problem: '题目',
  Problem_Score: 'OI 题目总分数',
  OI_Rank_Score: 'OI 排行榜得分',
  OI_Rank_Calculation_Rule: 'OI 排行得分计算公式',
  ...
  Discussion_title: '标题',
  Discussion_Desc: '描述',
  Associated_Problem:'讨论关联的题目 ID',
  Associated_Problem_Tips:'讨论关联的题目 ID, 例如 P1000',
  ...
  Can_not_exceed_255:'的长度不能超过 255',
  Can_not_exceed_65535:'的长度不能超过 65535',
  Can_not_exceed_10000:'的长度不能超过 10000',
  ...
  The_number_of_content_cannot_be_less_than_50: '内容字符数不能低于 50！',
  ...
  Compile_Tips1:"__int64 不是 ANSI 标准定义，只能在 VisualC++使用，在 GNU C++ 中应写成 long long 类型，scanf 和 printf 请使用 %lld 作为格式",
  Compile_Tips2:"main() 返回值必须定义为 int ，而不是 void",
  Compile_Tips3:"i 在循环外失去定义 \"for(int i = 0...){...}\"",
  Compile_Tips4:"itoa 不是 Ansi 标准函数（标准 C / C++ 中无此函数）",

  // /views/oj/about/Developer.vue
  Leader_BackEnd_FrontEnd_Engineer: '站长 & 前端 开发者',
  Distributed: '安全',
  Distributed_Desc: '判题沙盒使用 cgroup 隔离，网站权限控制完善',
  Customization: '定制',
  Customization_Desc: '网站配置高度集成，管理功能完善',
  Security: '开放',
  Security_Desc: '除违法信息外，可讨论任何话题',
  Diversity: '多样',
  Diversity_Desc: '支持 Codefoces，HDU，POJ，GYM，AtCoder，SPOJ 的远程判题',
  Available: '有效',
  Faulty: '不完善',
  ...
  No_Groups: '暂无团队',
  Group_Name: '团队名称',
  Group_Short_Name: '团队简称（团队题目展示 ID 前缀）',
  Group_Brief: '团队简介',
  ...
  Group_ACM_Rank_Type: 'ACM 排序',
  Group_OI_Rank_Type: 'OI 排序',
