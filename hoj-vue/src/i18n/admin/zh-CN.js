export const m = {
  ...
  Please_select_6_to_25_characters_for_password_length: '请输入 6 ~ 25 作为密码的长度',
  ...
  SMTP_Config: 'SMTP 设置',
  Email_BG: '邮件背景',
  Email_BG_Desc: '请输入邮件背景图的 Url 链接',
  ...
  Number_of_AC_required_for_ordinary_users_to_post:'普通用户发布帖子需要的 AC 题目数',
  Number_of_posts_that_users_can_create_per_day:'普通用户每天可以创建的帖子数',
  Number_of_AC_required_for_Comment_of_ordinary_users:'普通用户评论和回复需要的 AC 题目数',
  Group_Config:'团队配置',
  ...
  Number_of_AC_required_for_ordinary_users_to_create_group:'普通用户创建团队需要的 AC 题目数',
  Account_Config:'账号配置',
  Account:'账号',
  Add_Account:'增加账号',
  ...
  Display_ID: '展示 ID',
  Display_Title: '展示标题',
  Add_Rmote_OJ_Problem: '添加远程 OJ 题目',
  Add_From_Public_Problem: '从公共题库添加题目',
  ACM_Contest_Add_From_Public_Problem_Tips:'当前比赛为 ACM 赛制：只支持导入 ACM 类型的题目和远程题目',
  OI_Contest_Add_From_Public_Problem_Tips:'当前比赛为 OI 赛制：只支持导入 OI 类型的题目和远程题目',
  ...
  Enter_The_Problem_Display_ID_in_the_Contest: '请输入该题目在比赛中展示 ID',
  Problem_ID_is_required: '题目 ID 不能为空',
  The_Problem_Display_ID_in_the_Contest_is_required: '题目在比赛中的展示 ID 不能为空',
  Balloon_Color: '气球颜色',
  Update_Balloon_Color_Successfully: '更新该题气球颜色成功！',

  // /views/admin/problem/Problem.vue
  Problem_Display_ID: '题目展示 ID',
  Contest_Display_Title: '比赛中的展示标题',
  Contest_Display_ID: '比赛中的展示 ID',
  Description: '描述',
  ...
  Problem_Examples_Desc: '题目样例：请最好不要超过 2 个题目样例，题面样例不纳入评测数据。',
  Problem_Example: '样例',
  Example_Input: '样例输入',
  Example_Output: '样例输出',
  Add_Example: '添加样例',
  ...
  is_required: '不能为空！',
  Score_must_be_greater_than_or_equal_to_0: '分数必须是自然数！',
  Score_must_be_an_integer: '分数必须是整数！',
  Spj_Or_Interactive_Code: 'Spj或交互程序的代码',
  Spj_Or_Interactive_Code_not_Compile_Success: 'Spj 或交互程序的代码没有编译成功，请重新编译！',
  ...
  Tag_Tips:'提示：默认无标签分类栏，所有标签都是 未分类，请自行点击左上角 添加标签分类 按钮添加标签分类，再点击标签修改#标签分类#进行归类。',
  ...
  Export: '导出',
  Import_Problem: '导入题目',
  Import_QDUOJ_Problem: '导入 QDUOJ 的题目',
  Import_FPS_Problem: '导入 FPS 格式的题目',
  Import_Hydro_Problem: '导入 Hydro 的题目',
  ...
  SplitType_Problem: '以题目 ID 分割文件夹',
  ...
  Edit_Contest: '编辑比赛',
  Create_Contest: '创建比赛',
  Contest_Duration_Check: '比赛时长必须是正数',
